            ...
            <div class="md:flex items-start justify-between px-9 pt-20 md:pt-30">
                <div id="footer-lead" class="max-w-sm leading-relaxed mb-12">
                    ...
                    <div class="flex items-end space-x-4 mt-6">
                        ...
                        <a href="https://chatgpt.com/?hints=search&q=Read+https%3A%2F%2Fautomaze.io%2C+I+want+to+ask+questions+about+it." target="_blank" class="text-slate-400 hover:text-slate-200 transition-all"><svg
