<section id="about" class="pt-[20dvh]">
    ...
    <div>
        ...
        <div class="lg:flex justify-between gap-12">
            ...
            <div class="lg:max-w-2xl mt-6 text-neutral-700">
                <p>
            ...
            <div class="lg:max-w-md mt-24  lg:-mt-13 grid grid-cols-2 gap-4 sm:-mx-16 sm:grid-cols-4 lg:mx-0 lg:grid-cols-2 lg:gap-4 xl:gap-8">
