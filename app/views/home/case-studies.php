<section id="testimonials" class="bg-indigo-50/20">
  ...
  <div class="!py-12 isolate overflow-hidden">
    <figure class="grid grid-cols-1 items-center gap-x-6 gap-y-8 lg:gap-x-10 max-w-5xl md:px-6 mx-auto">
      ...
      <div class="col-end-1 w-16 lg:row-span-4 lg:w-72">
        <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=576&h=576&q=80" alt="" class="rounded-xl shadow ring-4 ring-slate-200" />
      </div>
