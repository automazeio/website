<section id="testimonials" class="bg-indigo-50/20">
  <h3 class="home-grid-header">
    <span>03 / What people say</span>
  </h3>
  <div class="isolate overflow-hidden">
    <div id="testimonial-rotator" class="relative mx-auto max-w-5xl md:px-6" aria-roledescription="carousel">
      <!-- Slide 1 -->
      <figure class="testimonial-slide m-1 p-2 grid grid-cols-1 items-center gap-x-6 gap-y-8 lg:gap-x-10">
        ...
        <div class="col-end-1 w-16 lg:row-span-4 lg:w-72">
          <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=576&h=576&q=80&fit=facearea&auto=format" alt="" class="rounded-xl shadow ring-4 ring-slate-200" />
        </div>
      ...
      <figure class="testimonial-slide m-1 p-2 grid grid-cols-1 items-center gap-x-6 gap-y-8 lg:gap-x-10">
        ...
        <div class="col-end-1 w-16 lg:row-span-4 lg:w-72">
          <img src="https://images.unsplash.com/photo-1502685104226-ee32379fefbe?w=576&h=576&q=80&fit=facearea&auto=format" alt="" class="rounded-xl shadow ring-4 ring-slate-200" />
        </div>
        <figcaption class="text-base lg:col-start-1 lg:row-start-3">
      ...
      <figure class="testimonial-slide m-1 p-2 grid grid-cols-1 items-center gap-x-6 gap-y-8 lg:gap-x-10">
        ...
        <div class="col-end-1 w-16 lg:row-span-4 lg:w-72">
          <img src="https://images.unsplash.com/photo-1527980965255-d3b416303d12?w=576&h=576&q=80&fit=facearea&auto=format" alt="" class="rounded-xl shadow ring-4 ring-slate-200" />
        </div>
        <figcaption class="text-base lg:col-start-1 lg:row-start-3">
      ...
      <figure class="testimonial-slide m-1 p-2 grid grid-cols-1 items-center gap-x-6 gap-y-8 lg:gap-x-10">
        ...
        <div class="col-end-1 w-16 lg:row-span-4 lg:w-72">
          <img src="https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=576&h=576&q=80&fit=facearea&auto=format" alt="" class="rounded-xl shadow ring-4 ring-slate-200" />
        </div>
        <figcaption class="text-base lg:col-start-1 lg:row-start-3">
