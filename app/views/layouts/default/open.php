...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php tiny::staticURL('/css/tooltips.min.css'); ?>?v=" media="all">
...
<?php if (!tiny::layout()->props('emptyLayout')) { include(__DIR__ . '/header.php'); } ?>
